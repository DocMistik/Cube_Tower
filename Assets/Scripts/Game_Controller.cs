...
//В скобочках порядок записывания кода (Пока что 34 действия)
...
public class Game_Controller : MonoBehaviour
{
    ...
    public GameObject cubeToCreate, allCubes, vfx; //Префаб куба, который будем создавать + ссылка на All Cubes в Unity(23)
